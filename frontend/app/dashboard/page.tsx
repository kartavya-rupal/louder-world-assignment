            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-muted-foreground mb-8">
                        Sign in with Google to access your events dashboard
                    </p>
                    <button
                        onClick={() => signIn("google")}
                        className="w-full bg-white hover:bg-gray-50 text-foreground font-medium py-3 px-6 rounded-lg shadow-md border border-border transition-all hover:shadow-lg flex items-center justify-center gap-2"
                    >
